...
#
# Purpose:      Phonebook Demo. Demonstrating OOP, Tkinter GUI module, using Tkinter Parent/Child relationships
#
# Module:       phonebook_gui, contains code for gui design and implementation
#
...
def load_gui(self):
    ...
    # define listbox with a scrollbar and grid them
